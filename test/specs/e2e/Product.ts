...
import { searchPhrase, alertText, deletedProductMessage} from "../../config/data";
...
describe("E2E - Products", async () => {
  ...
  it("Click on checkbox label, delete product from cart  ", async ()=> {
    ...
    await expect ( await CartPage.getDeletedAlerMessageValue()).toContain(deletedProductMessage)
